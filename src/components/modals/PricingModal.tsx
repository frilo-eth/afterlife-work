          ...
          <div className="container mx-auto px-4 py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <div className="group relative h-full">
                ...
                <div className="relative p-8 rounded-xl bg-black/20 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-colors h-full">
                  <span className="font-mono text-sm tracking-wider opacity-50 uppercase block mb-4">
                    Summon
                  </span>
                  <div className="mb-8">
                    <div className="text-3xl font-bold">$1,000</div>
                    <p className="text-sm text-white/60 mt-2">Essential files. Instant Delivery.</p>
                  </div>
              ...
              {/* Revival Tier */}
              <div className="group relative h-full">
                <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                <div className="relative p-8 rounded-xl bg-black/30 backdrop-blur-sm border-2 border-white/30 hover:border-white/40 transition-colors h-full">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-white/60 mt-2">Full editable files. Delivery in 2-3 days.</p>
                  </div>
                  <ul className="space-y-4">
                    <li className="text-sm text-white/60 flex items-center gap-2">
                      <span className="w-1 h-1 bg-white/60 rounded-full" />
              ...
              <div className="group relative h-full">
                ...
                <div className="relative p-8 rounded-xl bg-black/20 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-colors h-full">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-white/60 mt-2">Bespoke brand development. 2 weeks sprint.</p>
                  </div>
                  <ul className="space-y-4">
                    <li className="text-sm text-white/60 flex items-center gap-2">
                      <span className="w-1 h-1 bg-white/60 rounded-full" />
            ...
            <div className="text-center mt-16">
              <Button
                className="bg-black/20 backdrop-blur-sm border border-white/10 hover:bg-white/10 text-white"
                size="lg"
                onPress={onClose}
              >
                Back Home
