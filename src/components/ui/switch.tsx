...
import { animate, motion, type Transition, useMotionValue } from 'framer-motion'
import {
  forwardRef,
  type HTMLAttributes,
  useCallback,
...
interface SwitchProps extends HTMLAttributes<HTMLDivElement> {
  ...
  /** Pins the switch to one step of the size ladder (see Fluid /docs/sizes).
      ...
      >
        ...
        <SwitchPrimitive.Root
          ...
          style={{
            ...
            // Unchecked: Fluid's `var(--accent)` is an HSL triplet here, and
            // on dark cards it dissolved into the substrate. A foreground
            // wash + inset edge keeps the thumb readable at both ladder steps.
            ...
            boxShadow: checked ? undefined : 'inset 0 0 0 1px hsl(var(--border-strong))',
          }}
