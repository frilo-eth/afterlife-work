...
/**
 * Concentric nested corners: outer = inner + padding.
 * Keeps the gutter visually even around rounded children (not pinched).
 */
function nestedOuterRadius(innerRadiusPx: number, paddingPx: number): number {
  return innerRadiusPx + paddingPx
}

export type { ShapeClasses, ShapeVariant }
export { nestedOuterRadius, ShapeProvider, shapeMap, useShape, useShapeContext }
